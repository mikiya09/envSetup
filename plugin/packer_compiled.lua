...
_G.packer_plugins = {
  ["AutoSave.nvim"] = {
    loaded = true,
    path = "/Users/jojo/.local/share/nvim/site/pack/packer/start/AutoSave.nvim",
  ...
  ["nvim-transparent"] = {
    loaded = true,
    path = "/Users/jojo/.local/share/nvim/site/pack/packer/start/nvim-transparent",
  ...
  ["omni.vim"] = {
    loaded = true,
    path = "/Users/jojo/.local/share/nvim/site/pack/packer/start/omni.vim",
    url = "https://github.com/yonlu/omni.vim"
  },
  ["onenord.nvim"] = {
    loaded = true,
    path = "/Users/jojo/.local/share/nvim/site/pack/packer/start/onenord.nvim",
  ...
  ["vim-hexokinase"] = {
    loaded = true,
    path = "/Users/jojo/.local/share/nvim/site/pack/packer/start/vim-hexokinase",
