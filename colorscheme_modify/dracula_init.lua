...
M.apply = function()
	...
	highlight("TSConstant", colors.orange, nil, nil, nil)       ----------constant-------------
	...
	highlight("TSBoolean", colors.yellow, nil, nil, nil)        -------------boolean----------
